...
var CardSection = (function (_React$Component) {
  function CardSection(props) {
    _classCallCheck(this, _CardSection);

    _get(Object.getPrototypeOf(_CardSection.prototype), "constructor", this).call(this, props);
    var theme = this.props.theme;

    this.styles = new _styles3["default"](theme);
    this.name = "card_section";
  }

  _inherits(CardSection, _React$Component);

  var _CardSection = CardSection;

  _createClass(_CardSection, [{
    key: "classes",
    ...
    value: function selectDefault() {
      ...
      var cardTitle = this.styles.cardTitle;
    ...
    value: function render() {
      ...
      var hasTitle = !_ramda2["default"].contains(type, titleless);
      var element = this.selectElement();
      var _styles = this.styles;
      var base = _styles.base;
      var sectionTitle = _styles.sectionTitle;
      var smallerBottomMargin = _styles.smallerBottomMargin;

      var sectionStyles = hasTitle ? [base] : [base, smallerBottomMargin];
      return _react2["default"].createElement(
        "section",
  ...
  CardSection = (0, _radium2["default"])(CardSection) || CardSection;
  return CardSection;
